...
all classes except for verbs can be distinguished "on" type, e.g., common nouns
and proper nouns, while pronouns can be reflexive, reciprocal, personal or
interrogative.
...
Table \ref{adjresults}

All features except for number led to increases in parser accuracy scores.
Degree being the most promising with a reported LAS of 87.29\%, while
distinguishing adjectives on definiteness yield an LAS of 87.14\% and gender
leads to LAS of 87.10\%.
...
UAS identical to that of degree alone.
