...
configuration can be seens as tag set specifically optimized for dependency
...
By introducing more fine-grained linguistically motivated distinctions in the tag
...
However, this would also increase the complexity of the tagging task, 
