...
fine-grained morphological distinctions. However, in a realistic
setting where the aim is to parse raw text, this will often
require a separate step of morphological analysis in addition to
PoS-tagging that can be quite expensive.
