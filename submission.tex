...
The tag set modifications are realized through a mapping procedure that
concatenates the existing tag with one or more specified features for all
applicable tokens, i.e., tokens annotated with said tag and feature(s) in the
gold standard data.
...
results -- based on the annotations of the Norwegian Dependency Treebank using
